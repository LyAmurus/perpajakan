            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="mb-1 text-info">
                ...
                <div class="collapse" id="dashboard-collapse">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="pajak/daftarpajakindividu.php"
                        class="link-dark d-inline-flex text-decoration-none rounded">Daftar Pajak
                        Penghasilan</a>
                    </li>
                    <li><a href="pajak/daftarpajakperusahaan.php"
                        class="link-dark d-inline-flex text-decoration-none rounded">Daftar Pajak
                        Perusahaan</a></li>
                    <li><a href="pajak/daftarpajakkendaraan.php"
                        class="link-dark d-inline-flex text-decoration-none rounded">Daftar Pajak
                        Kendaraan</a>
                    </li>
                    <li><a href="pajak/daftarpajakpbb.php"
                        class="link-dark d-inline-flex text-decoration-none rounded">Daftar pajak
              ...
              <li class="mb-1 text-info">
                ...
                <div class="collapse" id="orders-collapse">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="pajak/informasi/informasipajakindividu.html"
                        class="link-dark d-inline-flex text-decoration-none rounded">Pajak Penghasilan</a>
                    </li>
                    <li><a href="pajak/informasi/informasipajakperusahaan.html"
                        class="link-dark d-inline-flex text-decoration-none rounded">Pajak Perusahaan</a>
                    </li>
                    <li><a href="pajak/informasi/informasipajakkendaraan.html"
                        class="link-dark d-inline-flex text-decoration-none rounded">Pajak Kendaraan</a>
                    </li>
                    <li><a href="pajak/informasi/informasipajakpbb.html"
              ...
              <li class="mb-1 text-info">
                ...
                <div class="collapse" id="account-collapse">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="pajak/profile/profil.php"
                        class="link-dark d-inline-flex text-decoration-none rounded">Profile</a>
                    </li>
                    <li><a href="pajak/profile/updateprofile.php" class="link-dark d-inline-flex text-decoration-none rounded">Profile Settings</a>
                    </li>
                    <li><a href="assets/signout.php" class="link-dark d-inline-flex text-decoration-none rounded">Sign
                        out</a>
                    </li>
                  </ul>
                </div>
              ...
              <div class="modal-header border-0" style="padding: 2rem; padding-bottom: 0">
                <a class="modal-title" id="targetModalLabel">
                  <img style="margin-top: 0.5rem"
                    src="https://cdn.discordapp.com/attachments/859678958689845278/1054459135216844800/image.png"
                    alt="" />
                </a>
        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <p class="text-caption">
              Pajak adalah iuran atau pungutan wajib yang harus dibayar oleh rakyat (wajib pajak) kepada negara
              berdasarkan undang-undang,
              dimana uang pajak tersebut akan digunakan untuk kepentingan pemerintah dan kesejahteraan masyarakat
              umum.<br class="d-sm-block d-none" />
            </p>
  ...
  <footer class="bg-light text-center text-white footer mt-auto">
    ...
    <div class="container p-4 pb-0">
      ...
      <section class="mb-4">
        ...
        <a class="btn text-white btn-floating m-1" style="background-color: #333333;" href="#!" role="button"><svg
