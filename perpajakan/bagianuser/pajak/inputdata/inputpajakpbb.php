<?php
    ...
    if(isset($_POST['inputpajakpbb'])){
        ...
        $result = "INSERT INTO data_pbb(username, nama, tanah, bangunan, harga_tanah, harga_bangunan, njop, njkp, pbb) 
                VALUES('$username', '$nama', '$tanah', '$bangunan', '$harga_tanah', '$harga_bangunan', '$njop', '$njkp', '$pbb')";
