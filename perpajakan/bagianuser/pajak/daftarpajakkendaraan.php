...
session_start();
$result = mysqli_query($conn, "SELECT * FROM data_kendaraan_motor1 WHERE username='$_SESSION[username]'");
$result2 = mysqli_query($conn, "SELECT * FROM data_kendaraan_motor5 WHERE username='$_SESSION[username]'");
$result3 = mysqli_query($conn, "SELECT * FROM data_kendaraan_mobil1 WHERE username='$_SESSION[username]'");
$result4 = mysqli_query($conn, "SELECT * FROM data_kendaraan_mobil5 WHERE username='$_SESSION[username]'");
?>
...
<body class="d-flex flex-column min-vh-100">
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="mb-1 text-info">
                                ...
                                <div class="collapse" id="orders-collapse">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                        <li><a href="informasi/informasipajakindividu.php"
                                                class="link-dark d-inline-flex text-decoration-none rounded">Pajak
                                                Penghasilan</a>
                                        </li>
                                        <li><a href="informasi/informasipajakperusahaan.php"
                                                class="link-dark d-inline-flex text-decoration-none rounded">Pajak
                                                Perusahaan</a>
                                        </li>
                                        <li><a href="informasi/informasipajakkendaraan.php"
                                                class="link-dark d-inline-flex text-decoration-none rounded">Pajak
                                                Kendaraan</a>
                                        </li>
                                        <li><a href="informasi/informasipajakpbb.php"
    ...
    <main class="mt-3 mb-5">
        <div class="mt-5 mb-5 container-fluid table-responsive">
            ...
            <!--FORM AKHIR DATA-->
            <div class="d-grid gap-2 col-6 mx-auto mb-4">
                <a style="display: none;" id="tambah-data-4" class="btn btn-success" type="button"
                    data-bs-toggle="modal" data-bs-target="#adddata4">Tambahh
                    Data</a>
            </div>
