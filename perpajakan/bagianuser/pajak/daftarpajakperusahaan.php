<?php
    ...
    session_start();
    $result = mysqli_query($conn, "SELECT * FROM data_perusahaan WHERE username='$_SESSION[username]'");
?>
    ...
    <main class="mt-3 mb-5">
        <nav class="mt-5 container-fluid">
            <table class="table table-hover table-striped-columns caption-top">
                <caption>Berisi daftar pajak perusahaan yang telah diinputkan</caption>
                <thead>
                    <tr>
                        <th scope="col">ID</th>
                        <th scope="col">Nama PT</th>
                        <th scope="col">Peredaran Bruto</th>
                ...
                <tbody>
                    <tr>
                        <td><?php echo $no++?></td>
                        <td><?php echo $user_data['namapt'] ?></td>
                        <td>IDR.<?php echo $user_data['bruto'] ?></td>
                        <td>IDR.<?php echo $user_data['pkp'] ?></td>
                        <td>IDR.<?php echo $user_data['pph'] ?></td>
                        <td>
                ...
                <div class="modal fade" id="updata<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <!--FORM-->
                            <form action="./editdata/editpajakperusahaan.php" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="namapt"
                                            value="<?=$user_data['namapt']?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Peredaran Bruto</label>
                                        <input type="text" class="form-control" name="bruto"
                                            value="<?=$user_data['bruto']?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Penghasilan Kena Pajak</label>
            ...
            <div class="modal fade" id="adddata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!--FORM-->
                        <form action="inputdata/inputpajakperusahaan.php" method="POST">
                            <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success" name="inputpajakperusahaan">Add</button>
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                            </div>
                        </form>
            ...
            <!-- <div class="d-grid gap-2 col-6 mx-auto">
                <a class="btn btn-success" type="button" href="inputdata/inputpajakperusahaan.html">Tambah Data</a>
                <a class="btn btn-warning" type="button" href="../homeuser.html">Back</a>
            </div> -->
        </nav>
    </main>
    ...
    <script type="text/javascript">
        function delete_data(uid) {
            if (confirm('Yakin ingin hapus?')) {
                window.location.href = 'deletedata/deletepajakperusahaan.php?id=' + uid;
            }
        }
    </script>
</body>
