<?php
    ...
    if(isset($_POST['update'])){
        ...
        $result = "UPDATE data_pbb SET nama='$nama', tanah='$tanah', bangunan='$bangunan', harga_tanah='$harga_tanah', harga_bangunan='$harga_bangunan', njop='$njop', njkp='$njkp', pbb='$pbb' WHERE id='$id' AND username='$username'";
