...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE data_user SET fname='$fname', lname='$lname', nik='$nik', adress='$adress', email='$email' WHERE username='$usersaatini'";
                    ...
                    <form method="post" class="acc-edit-frm">
                        ...
                        <div class="form-2">
                            ...
                            <div class="inner-form-2-2">
                                <p>Tanggal Lahir</p>
                                <input type="text" id="TanggalLahir"value="<?php ?>">
                                </div>
                            <div class="form-3">
                            ...
                            <a href=" ../homepageuser.php" class="btn btn-defauly">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
