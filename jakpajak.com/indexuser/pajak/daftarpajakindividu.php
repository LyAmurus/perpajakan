...
<body>
        ...
        <nav class="mt-5 container-fluid">
            <table class="table table-hover table-striped-columns caption-top">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class='btn btn-warning' href="#" data-bs-toggle="modal" data-bs-target="#updata<?php echo $no ?>">Edit</a>
                    ...
                    <form action="./editdata/editpajakindividu.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama" value="<?=$user_data['nama']?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Gaji</label>
                                <input type="text" class="form-control" name="gaji" value="<?=$user_data['gaji']?>">
                            </div>
                        </div>
            ...
            <div class="modal fade" id="adddata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" name="inputpajakindividu">Add</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                    </div>
                    </form>
    ...
    function delete_data(uid)
    {
        ...
        {
            window.location.href = 'deletedata/deletepajakindividu.php?id='+uid;
        }
    }
